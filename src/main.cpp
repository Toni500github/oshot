...
int main(int, char*[])
{
    ...
    {
        case X11:     result = capture_full_screen_x11(); break;
        case WAYLAND: result = capture_full_screen_wayland(); break;
        default:      return 1;
    }

    if (!result.success)
    {
        std::cerr << "Failed to do data screenshot: " << result.error_msg << std::endl;
        return 1;
    }
